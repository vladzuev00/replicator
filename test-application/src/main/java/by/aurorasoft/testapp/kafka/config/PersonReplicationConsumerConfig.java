...
import by.aurorasoft.replicator.consumer.KafkakaReplicationConsumerStarter;
...
@Component
public final class PersonReplicationConsumerConfig extends KafkakaReplicationConsumerStarter<Long, ReplicatedPerson> {
