...
public final class ReplicatedSaveProcessor extends ReplicateAnnotationProcessor {

    public ReplicatedSaveProcessor(Class<Annotation> annotation, String errorMessage) {
