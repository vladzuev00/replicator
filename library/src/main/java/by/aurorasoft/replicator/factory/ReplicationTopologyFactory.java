...
public final class ReplicationTopologyFactory {
    ...
    public <E, ID> Topology create(ReplicationConsumer<E, ID> pipeline) {
    ...
    private <ID> ConsumingSerde<ID> getIdSerde(ReplicationConsumer<?, ID> pipeline) {
        return new ConsumingSerde<>(pipeline.getIdDeserializer());
    }

    private <E, ID> ConsumingSerde<ConsumedReplication<E, ID>> getReplicationSerde(ReplicationConsumer<E, ID> pipeline) {
