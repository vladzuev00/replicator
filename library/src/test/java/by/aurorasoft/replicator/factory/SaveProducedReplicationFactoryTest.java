...
//
//    @Captor
//    private ArgumentCaptor<View[]> viewConfigsArgumentCaptor;
//
//    @Before
...
//        when(mockedDtoJsonViewFactory.create(same(givenSavedDto), any(View[].class)))
...
//
//        View[] expectedViewConfigs = new View[]{
//                createViewConfig(
//                        TestV2Dto.class,
...
//    }
//
//    private void verifyViewConfigs(View[] expected) {
//        verify(mockedDtoJsonViewFactory, times(1)).create(any(), viewConfigsArgumentCaptor.capture());
//        View[] actual = viewConfigsArgumentCaptor.getValue();
