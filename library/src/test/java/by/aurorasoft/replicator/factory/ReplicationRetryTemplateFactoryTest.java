...
//
//import by.aurorasoft.replicator.exception.RelationNotDeliveredException;
...
//            verify(constructedBuilder, times(1)).retryOn(same(RelationNotDeliveredException.class));
//        }
//    }
//
