...
import static by.aurorasoft.replicator.util.ReplicationAssertUtil.assertProducedDelete;
import static by.aurorasoft.replicator.util.ReplicationAssertUtil.assertProducedSave;
...
public final class ProducingReplicationAspectTest extends AbstractSpringBootTest {
    ...
    public void createShouldBeReplicated() {
        ...
        assertProducedSave(actualReplication, givenDto);
    }
    ...
    public void createAllShouldBeReplicated() {
        ...
        assertProducedSave(actualReplications.get(0), firstGivenDto);
        assertProducedSave(actualReplications.get(1), secondGivenDto);
    }
    ...
    public void deleteByIdShouldBeReplicated() {
        ...
        final ProducedReplication<Long> actualReplication = replicationArgumentCaptor.getValue();
        assertProducedDelete(actualReplication, givenId);
    }
